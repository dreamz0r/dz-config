...
class CfgVehicles
{
	...
	class Land_Mil_FireStation: HouseNoDestruct
	{
		scope=1;
	...
	class Land_City_Hospital_Ghost1: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\Residential\Medical\City_Hospital_Ghost1.p3d";
	};
	class Land_City_Hospital_Ghost2: HouseNoDestruct
	{
		scope=1;
	...
	class Land_Village_HealthCare_Ghost1: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\Residential\Medical\Village_HealthCare_Ghost1.p3d";
	};
	class Land_Village_HealthCare_Ghost2: HouseNoDestruct
	{
		scope=1;
	...
	class Land_Office2_Ghost1: HouseNoDestruct
	{
		scope=1;
		model="\DZ\structures\Residential\Offices\Office2_Ghost1.p3d";
	};
	class Land_Office2_Ghost2: HouseNoDestruct
	{
		scope=1;
	...
	class StaticObj_Misc_CrashBarrier_nolc: HouseNoDestruct
	{
		scope=1;
	...
	class StaticObj_EmergencyBlanket_discarded: HouseNoDestruct
	{
		scope=1;
