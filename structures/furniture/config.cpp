...
class CfgVehicles
{
	...
	class StaticObj_Pillow_Flannel: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Beds\Pillow_Flannel.p3d";
	};
	class StaticObj_Pillow_Grey: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Beds\Pillow_Grey.p3d";
	};
	class StaticObj_Pillow_Old: HouseNoDestruct
	{
		scope=1;
	...
	class StaticObj_Stretcher_Green: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Beds\Stretcher_Green.p3d";
	};
	class StaticObj_Stretcher_Red: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Beds\Stretcher_Red.p3d";
	};
	class StaticObj_Stretcher_Green_Folded: HouseNoDestruct
	{
		scope=1;
		model="DZ\structures\Furniture\Beds\Stretcher_Green_Folded.p3d";
	};
	class StaticObj_Stretcher_Red_Folded: HouseNoDestruct
	{
		scope=1;
