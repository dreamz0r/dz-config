...
class CfgNonAIVehicles
{
	...
	class Static_stone10_moss_lc: StaticObject
	{
	};
	...
	class Static_stone6_moss_lc: StaticObject
	{
	};
	...
	class Static_stone7_moss_lc: StaticObject
	{
	};
	...
	class Static_stone8_moss_lc: StaticObject
	{
	};
	...
	class Static_stone9_moss_lc: StaticObject
	{
	};
};
