...
class CfgWorlds
{
	...
	class DefaultLighting
	{
		...
		moonObjectColorFull[]={0.40000001,0.40000001,0.5,1};
		moonHaloObjectColorFull[]={0.40000001,0.40000001,0.5,0};
		moonsetObjectColor[]={0.5,0.33000001,0.27000001};
		moonsetHaloObjectColor[]={0.5,0.33000001,0.27000001};
		nightAngle=5;
		sunSunset=20;
		endSunset=10;
		moonDayIntensity=20.5;
		moonNightIntensity=5.3000002;
	};
	class DefaultWorld
	{
		class Weather
	...
	class CAWorld: DefaultWorld
	{
		class Weather: Weather
		{
			class LightingNew
			{
				class C_Night
				{
					...
					sunAngle=-18;
					sunOrMoon=0;
					diffuse[]={0.1,0.15000001,0.30000001};
					diffuseCloud[]={0.1,0.15000001,0.30000001};
					bidirect[]={0,0,0};
					bidirectCloud[]={0,0,0};
					ambient[]={0.032000002,0.059999999,0.096000001};
					ambientCloud[]={0.032000002,0.059999999,0.096000001};
					groundReflection[]={0.0040000002,0.0071999999,0.012};
					groundReflectionCloud[]={0.0040000002,0.0071999999,0.012};
					...
					spaceIntensity=0.69999999;
					atmosphereIntensity=0.30000001;
					starsIntensity=0.064999998;
					luminanceRectCoef=0;
				...
				class C_Astro2
				{
					...
					EVMax=0;
					filmGrainIntensity=0;
					spaceIntensity=0.60000002;
					atmosphereIntensity=0.40000001;
					starsIntensity=0.064999998;
					luminanceRectCoef=0;
					luminanceRectCoefCloud=0;
					rayleigh[]={0,0,0};
				...
				class C_Nautical1
				{
					...
					groundReflection[]={0.016000001,0.0288,0.048};
					groundReflectionCloud[]={0.016000001,0.0288,0.048};
					sky[]={0.017999999,0.028000001,0.043000001};
					skyAroundSun[]={0.017999999,0.028000001,0.043000001};
					...
					EVMax=0.5;
					filmGrainIntensity=0;
					spaceIntensity=0.40000001;
					atmosphereIntensity=0.60000002;
					starsIntensity=0.064999998;
					luminanceRectCoef=0;
					luminanceRectCoefCloud=0;
					rayleigh[]={0,0,0};
				...
				class C_Nautical2
				{
					...
					groundReflectionCloud[]={0.016000001,0.0288,0.048};
					sky[]={0.017999999,0.028000001,0.043000001};
					skyAroundSun[]={0.15000001,0.075000003,0.13};
					desiredLuminanceCoef=0.14;
					desiredLuminanceCoefCloud=0.14;
					EVMin=-2;
					EVMax=0.5;
					filmGrainIntensity=0;
					spaceIntensity=0.30000001;
					atmosphereIntensity=0.69999999;
					starsIntensity=0.064999998;
					luminanceRectCoef=0;
					luminanceRectCoefCloud=0;
					rayleigh[]={0,0,0};
				...
				class C_Nautical3
				{
					...
					groundReflection[]={0.032000002,0.0572,0.096000001};
					groundReflectionCloud[]={0.032000002,0.0572,0.096000001};
					sky[]={0.017999999,0.028000001,0.043000001};
					skyAroundSun[]={0.3039,0.152,0.27090001};
					...
					filmGrainIntensity=0;
					spaceIntensity=0.2;
					atmosphereIntensity=0.80000001;
					starsIntensity=0.064999998;
					luminanceRectCoef=0;
					luminanceRectCoefCloud=0;
					rayleigh[]={0,0,0};
				...
				class C_Civil1
				{
					...
					skyAroundSun[]={0.60390002,0.30000001,0.45089999};
					desiredLuminanceCoef=0.17;
					desiredLuminanceCoefCloud=0.17;
					EVMin=-2;
					EVMax=0.5;
					filmGrainIntensity=0;
					spaceIntensity=0.1;
					atmosphereIntensity=0.89999998;
					starsIntensity=0.064999998;
					luminanceRectCoef=0;
					luminanceRectCoefCloud=0;
					rayleigh[]={0,0,0};
				...
				class C_Day0
				{
					...
					sky[]=
					{
						{1.6,0.99000001,0.89999998},
						-1
					};
					skyAroundSun[]=
					{
						{1.5,0.42109999,0.15000001},
						0.2
					};
					desiredLuminanceCoef=0.41999999;
					desiredLuminanceCoefCloud=0.41999999;
					EVMin=-2;
					EVMax=0.1;
					filmGrainIntensity=0;
					spaceIntensity=0;
				...
				class C_Day4
				{
					...
					skyAroundSun[]=
					{
						{1.9,0.80000001,0.30000001},
						7
					};
					desiredLuminanceCoef=0.47999999;
					desiredLuminanceCoefCloud=0.47999999;
					EVMin=-2;
					EVMax=0.1;
					filmGrainIntensity=0;
					spaceIntensity=0;
				...
				class O_Night
				{
					...
					groundReflection[]={0.0049999999,0.0049999999,0.0074999998};
					groundReflectionCloud[]={0.0049999999,0.0049999999,0.0074999998};
					sky[]={0.0099999998,0.0099999998,0.0099999998};
					skyAroundSun[]={0.0099999998,0.0099999998,0.0099999998};
					desiredLuminanceCoef=0.079999998;
					desiredLuminanceCoefCloud=0.079999998;
					EVMin=-2;
					EVMax=0;
					filmGrainIntensity=0;
					spaceIntensity=0;
				...
				class O_Astro1
				{
					...
					ambient[]={0.035999998,0.057,0.085000001};
					ambientCloud[]={0.035999998,0.057,0.085000001};
					groundReflection[]={0.0099999998,0.0099999998,0.015};
					groundReflectionCloud[]={0.0099999998,0.0099999998,0.015};
					sky[]={0.0099999998,0.0099999998,0.0099999998};
					skyAroundSun[]={0.0099999998,0.0099999998,0.0099999998};
					desiredLuminanceCoef=0.079999998;
					desiredLuminanceCoefCloud=0.079999998;
				...
				class O_Nautical1
				{
					...
					skyAroundSun[]={0.050000001,0.07,0.11};
					desiredLuminanceCoef=0.090000004;
				...
				class O_Day0
				{
					...
					ambient[]={0.145,0.227,0.34900001};
					ambientCloud[]={0.145,0.227,0.34900001};
					groundReflection[]={0.02,0.02,0.029999999};
					groundReflectionCloud[]={0.02,0.02,0.029999999};
					sky[]={0.1,0.14,0.16};
				...
				class O_Day4
				{
					...
					desiredLuminanceCoef=0.23999999;
					desiredLuminanceCoefCloud=0.23999999;
					EVMin=-2;
					EVMax=0;
					filmGrainIntensity=0;
					spaceIntensity=0;
				...
				class O_Day8
				{
					...
					desiredLuminanceCoef=0.27000001;
					desiredLuminanceCoefCloud=0.27000001;
					EVMin=-2;
					EVMax=0;
					filmGrainIntensity=0;
					spaceIntensity=0;
				...
				class O_Day12
				{
					...
					desiredLuminanceCoef=0.31999999;
					desiredLuminanceCoefCloud=0.31999999;
					EVMin=-2;
					EVMax=0;
					filmGrainIntensity=0;
					spaceIntensity=0;
				...
				class O_Day35
				{
					...
					desiredLuminanceCoefCloud=0.34;
					EVMin=-2;
					EVMax=0;
					filmGrainIntensity=0;
					spaceIntensity=0;
			...
			class Fog
			{
				nearDistanceFraction=0.40000001;
				farDistanceFraction=0.80000001;
			};
			class RainFog
			{
				distance=600;
			...
			class Overcast: Overcast
			{
				class Weather1: Weather1
				{
					...
					cloud="DZ\worlds\chernarusplus\data\Cloud_Stage00_Transparent_sky.paa";
					alpha=0;
					bright=0;
					speed=0.1;
					size=0.5;
		...
		starsIntensity=0.18099999;
		skyObject="DZ\Data\data\obloha.p3d";
		skyObjectRotationAxis[]={0,1,0};
		skyObjectRotationSpeed=0;
		horizontObject="DZ\Data\data\horizont.p3d";
		horizontObjectRotationAxis[]={0,1,0};
		horizontObjectRotationSpeed=0;
		hazeDistCoef=0;
		hazeFogCoef=1;
		volFogOffset=0;
		...
		terrainNormalPower=3.21;
		flareMinDistance=2;
		flareMinDistanceLerp=1;
		farLightSpotMul=0.1;
		farLightPointMul=0.1;
		farLightStartLerp=0.64999998;
		farLightEndLerp=0.050000001;
		minTreesInForestSquare=10;
		minRocksInRockSquare=5;
		MaxTide=1.5;
		MaxWave=0.25;
		waveOctaves=6;
		wavePersistence=0.745;
		waveFrequency=9;
		waveAmplitude=0.081;
...
class InventoryLighting
{
	lightDir[]={0.5,2,0.5};
	diffuseColor[]={2.4000001,2.4000001,2.28,1};
	ambientColor[]={4.8000002,4.8000002,5.1599998,1};
	groundColor[]={0.22,0.25,0.2,1};
	sunColor[]={1.5,1.5,1,1};
};
class MapDefaults
{
	ptsPerSquareSea=8;
	...
	class Legend
	{
		...
		sizeEx=0.02;
		colorBackground[]={0.75,0.75,0.75,0.80000001};
		color[]={0,0,0,1};
	};
	class Bush
	{
...
class CfgVehicles
{
	...
	class Inventory_Base: Static
	{
		...
		class EnvironmentWetnessIncrements
		{
			...
			{
				parentWithLiquid=1;
				wetParent=0.0049999999;
			};
			class Drying
			{
				player=0.00029;
				ground=0.00011;
				playerHeatSource=0.0035000001;
	...
	class AnniversaryMusicSource: HouseNoDestruct
	{
		scope=2;
		model="\DZ\data\empty.p3d";
	};
	class AnniversarySpotLight: HouseNoDestruct
	{
		scope=2;
		model="\DZ\data\empty.p3d";
	};
	...
	class Edible_Base: Inventory_Base
	{
		...
		varTemperatureFreezeTime=3960;
		varTemperatureThawTime=3960;
		varTemperatureOverheatTime=120;
...
class cfgAmmoTypes
{
	class AType_Bullet_HuntingBolt
	{
		name="Bullet_HuntingBolt";
	};
	class AType_Bullet_ImprovisedBolt_1
	{
		name="Bullet_ImprovisedBolt_1";
	};
	class AType_Bullet_ImprovisedBolt_2
	{
		name="Bullet_ImprovisedBolt_2";
	};
	class AType_Bullet_ImprovisedBolt_3
	{
		name="Bullet_ImprovisedBolt_3";
	};
	class AType_Bullet_CupidsBolt
	{
		name="Bullet_CupidsBolt";
	};
...
class cfgWeapons
{
	...
	class Rifle_Base: RifleCore
	{
		...
		class Reliability
		{
			ChanceToJam[]={0,0.001,0.0099999998,0.1,1};
		};
		class MeleeModes
		{
			class Default
	...
	class Pistol_Base: PistolCore
	{
		...
		debug_ItemCategory=1;
		sightMisalignmentModifier[]={0.40000001,1.5,0};
		rotationFlags=17;
		soundAttType="None";
		cursor="aimGunGhost";
		cursorAim="aimPistol";
